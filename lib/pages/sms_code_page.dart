    ...
    return Scaffold(
     ...
     body: Column(
       ...
       children: [
         Center(
           child: Padding(
             padding: const EdgeInsets.only(bottom: 60,left:50 ,right:50 ,top:80 ,),
             child: Text("SMS Code",style: TextStyle(fontSize: 36,color: primaryColor,
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("code",style: TextStyle(color: primaryColor,fontWeight: FontWeight.bold,fontSize: 16),),
                ),
